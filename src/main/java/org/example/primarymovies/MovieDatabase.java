...
public class MovieDatabase {
    public static void initialize(MovieListing movieListing){
        movieListing.addMovies("Beder Meye Josna", "Iliyas Kanchon-Babita", "Romantic-Drama", "2-3-1993", "3cr");
        movieListing.addMovies("kacher manush dure thuiya", "Farin-Pritom", "Romantic-Realization", "1-1-2024", "50Lacs");
        movieListing.addMovies("Dhamal", "Sanjay Datt-Arshad", "Comedy", "7-9-2007", "1cr");
        movieListing.addMovies("Monpura", "Chanchal", "Romantic-Realization", "13-2-2009", "5Lacs");
